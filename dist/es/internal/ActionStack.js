...
var argsToArray = function argsToArray() {
  ...
  return _lodash["default"].isArray(_lodash["default"].first(keys)) ? _lodash["default"].first(keys) : keys;
};
var ActionStack = /*#__PURE__*/function (_Smart) {
  function ActionStack() {
    ...
    _this = _callSuper(this, ActionStack, [].concat(args));
    _defineProperty(_this, "keys", {});
    _defineProperty(_this, "stack", []);
    _defineProperty(_this, "persisted", []);
    return _this;
  }
  _inherits(ActionStack, _Smart);
  return _createClass(ActionStack, [{
    key: "push",
    ...
    value: function clear() {
      ...
      this.stack = force ? [] : _lodash["default"].filter(this.stack, function (item) {
        return _lodash["default"].includes(_this2.persisted, item.key);
      });
    }
  }, {
    key: "clearExcept",
    value: function clearExcept() {
      ...
      this.stack = _lodash["default"].filter(this.stack, function (item) {
        return _lodash["default"].includes(_this3.persisted, item.key) || _lodash["default"].includes(preserve, item.key);
      });
    }
  }, {
    key: "clearSome",
    value: function clearSome() {
      ...
      this.stack = _lodash["default"].filter(this.stack, function (item) {
        return !_lodash["default"].includes(actions, item.key);
      });
    }
  }, {
    key: "clearOnChange",
    value: function clearOnChange() {
      ...
      _lodash["default"].each(this.keys, function (value, key) {
        if (!_lodash["default"].isEmpty(_this4.keys) && value !== keys[key]) {
          _this4.clear(true);
        }
      });
      this.keys = keys;
    ...
    value: function persist() {
      ...
      var keys = argsToArray(args);
      (_this$persisted = this.persisted).push.apply(_this$persisted, _toConsumableArray(keys));
    }
  }, {
    key: "find",
    ...
    value: function getErrors() {
      var key = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
      var stack = key ? this.find(key) : this.own();
      return _lodash["default"].filter(stack, function (action) {
    ...
    value: function isError() {
      ...
      _lodash["default"].each(keys, function (key) {
        ...
        _lodash["default"].each(actions, function (action) {
    ...
    value: function lastOf() {
      ...
      var lastOf;
      _lodash["default"].each(keys, function (key) {
        var action = _lodash["default"].last(_this10.find(key));
    ...
    value: function groups() {
      ...
      var groups = _lodash["default"].groupBy(this.stack, 'key');
      return _lodash["default"].mapValues(groups, function (stack) {
        return _lodash["default"].map(stack, function (item) {
          var stackId = item.id;
          return _lodash["default"].find(actions, function (action) {
    ...
    value: function own() {
      ...
      var state = Store.getInternalState();
      var actions = state.actions;
      var map = _lodash["default"].map(this.stack, function (item) {
        var stackId = item.id;
        return _lodash["default"].find(actions, function (action) {
          return stackId === action.id;
        });
      });
      return _lodash["default"].compact(map);
    }
  }, {
    key: "all",
    value: function all() {
    ...
    value: function getMetaPer(key) {
      ...
      if (action) {
        ...
        return _lodash["default"].find(resources, function (meta) {
          return _lodash["default"].includes(meta.actionIds, action.id);
        });
      }
    }
  }, {
    ...
    value: function getInstances(key) {
      var groups = _lodash["default"].groupBy(this.stack, 'key');
      return _lodash["default"].isArray(groups[key]) ? groups[key].map(function (item) {
      ...
      var _abort = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _lodash["default"].each(this.stack, function (_ref2) {
...
var _default = exports["default"] = ActionStack;
